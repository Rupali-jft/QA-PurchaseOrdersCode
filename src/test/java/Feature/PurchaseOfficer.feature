Feature: PO Login
  ...
  Scenario: Request Initiator Role Login, Add and Details Request, KPI's and Logout
    ...
    And Input values in Add Purchase Order Page

      | PoDate     | PoVendor   | PoSubject | PoReference| PoVendorAddress | PoItemName |PoPartNo | PoDescription | PoQty | PoUnit |
      | 06/09/2019 | Test Quote | Renuka    | 500        | Hyderabad       | Cell       | 1       | Cell          | 3     | 1      |
